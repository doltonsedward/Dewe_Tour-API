...
const { getCountrys, addCountry, getCountry } = require('../controllers/country') 
const { getTrips, addTrip, detailTrip, deleteTrip, updateTrip } = require('../controllers/trip') 
const { addTransaction, getTransactions, deleteTransaction, updateTransaction, getTransaction, updateTransactionInAdmin } = require('../controllers/transaction') 
...
router.patch('/transaction/:id/admin', auth, checkAdmin, updateTransactionInAdmin) 
